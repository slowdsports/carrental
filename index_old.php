...
<li><i class="fa fa-calendar" aria-hidden="true"></i>Año <?php echo htmlentities($result->ModelYear);?></li>
...
<span class="price">HNL<?php echo htmlentities($result->PricePerDay);?> /Día</span> 
</div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Sección: <span>Comentarios</span></h2>
    </div>
    <div class="row">
